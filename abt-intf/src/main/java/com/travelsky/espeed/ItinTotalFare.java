...
public class ItinTotalFare {
    ...
    protected ItinTotalFare.Fees fees;
     ...
     * @return
     *     possible object is
     *     {@link ItinTotalFare.Fees }
     *     
     */
    public ItinTotalFare.Fees getFees() {
        return fees;
    }
     ...
     *     
     */
    public void setFees(ItinTotalFare.Fees value) {
        this.fees = value;
    }
    ...
    public static class Fees {
        ...
        protected List<ItinTotalFare.Fees.Fee> fee;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ItinTotalFare.Fees.Fee }
         * 
         * 
         */
        public List<ItinTotalFare.Fees.Fee> getFee() {
            if (fee == null) {
                fee = new ArrayList<ItinTotalFare.Fees.Fee>();
            }
            return this.fee;
        }
