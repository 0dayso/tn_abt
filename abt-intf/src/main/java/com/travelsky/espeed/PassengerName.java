 ...
 *       &lt;attribute name="PassengerRefNumber" type="{http://www.w3.org/2001/XMLSchema}decimal" />
...
@XmlRootElement(name = "PassengerName")
public class PassengerName {
    ...
    @XmlAttribute(name = "PassengerRefNumber")
    protected BigDecimal passengerRefNumber;
     ...
     *     
     */
    public BigDecimal getPassengerRefNumber() {
        return passengerRefNumber;
    }

    /**
     * 设置passengerRefNumber属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setPassengerRefNumber(BigDecimal value) {
        this.passengerRefNumber = value;
    }
