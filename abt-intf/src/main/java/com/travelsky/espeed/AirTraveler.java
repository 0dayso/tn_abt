 ...
 *         &lt;element ref="{http://espeed.travelsky.com}PassengerTypeQuantity" minOccurs="0"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="PassengerFlightBinding" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="FlightSegmentRPH" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *                   &lt;element name="FlightSegmentRPHStatus" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *       &lt;attribute name="TravelerStatus" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class AirTraveler {
    ...
    protected List<AirTraveler.AddressFlightBinding> addressFlightBinding;
    @XmlElement(name = "DocumentFlightBinding")
    protected List<AirTraveler.DocumentFlightBinding> documentFlightBinding;
    @XmlElement(name = "PassengerFlightBinding", required = true)
    protected List<AirTraveler.PassengerFlightBinding> passengerFlightBinding;
    ...
    @XmlAttribute(name = "TravelerStatus")
    protected String travelerStatus;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirTraveler.AddressFlightBinding }
     * 
     * 
     */
    public List<AirTraveler.AddressFlightBinding> getAddressFlightBinding() {
        if (addressFlightBinding == null) {
            addressFlightBinding = new ArrayList<AirTraveler.AddressFlightBinding>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirTraveler.DocumentFlightBinding }
     * 
     * 
     */
    public List<AirTraveler.DocumentFlightBinding> getDocumentFlightBinding() {
        if (documentFlightBinding == null) {
            documentFlightBinding = new ArrayList<AirTraveler.DocumentFlightBinding>();
        }
        return this.documentFlightBinding;
    }

    /**
     * Gets the value of the passengerFlightBinding property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the passengerFlightBinding property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPassengerFlightBinding().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirTraveler.PassengerFlightBinding }
     * 
     * 
     */
    public List<AirTraveler.PassengerFlightBinding> getPassengerFlightBinding() {
        if (passengerFlightBinding == null) {
            passengerFlightBinding = new ArrayList<AirTraveler.PassengerFlightBinding>();
        }
        return this.passengerFlightBinding;
    }
     ...
     *     
     */
    public void setTravelerStatus(String value) {
        this.travelerStatus = value;
    }
    ...
    @XmlType(name = "", propOrder = {
        "flightSegmentRPH",
        "flightSegmentRPHStatus"
    })
    public static class PassengerFlightBinding {

        @XmlElement(name = "FlightSegmentRPH", required = true)
        protected String flightSegmentRPH;
        @XmlElement(name = "FlightSegmentRPHStatus", required = true)
        protected String flightSegmentRPHStatus;
         ...
         *     
         */
        public String getFlightSegmentRPHStatus() {
            return flightSegmentRPHStatus;
        }

        /**
         * 设置flightSegmentRPHStatus属性的值。
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setFlightSegmentRPHStatus(String value) {
            this.flightSegmentRPHStatus = value;
        }
