 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://espeed.travelsky.com}AirTravelerAvail2" maxOccurs="unbounded" minOccurs="0"/>
...
public class TravelerInfoSummary2 {

    @XmlElement(name = "AirTravelerAvail")
    protected List<AirTravelerAvail2> airTravelerAvail;
     ...
     * {@link AirTravelerAvail2 }
     * 
     * 
     */
    public List<AirTravelerAvail2> getAirTravelerAvail() {
        if (airTravelerAvail == null) {
            airTravelerAvail = new ArrayList<AirTravelerAvail2>();
        }
