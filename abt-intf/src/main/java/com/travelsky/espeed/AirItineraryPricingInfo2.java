 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://espeed.travelsky.com}ItinTotalFare2" maxOccurs="unbounded" minOccurs="0"/>
...
public class AirItineraryPricingInfo2 {
    ...
    protected List<ItinTotalFare2> itinTotalFare;
     ...
     * 
     */
    public List<ItinTotalFare2> getItinTotalFare() {
        if (itinTotalFare == null) {
            itinTotalFare = new ArrayList<ItinTotalFare2>();
        }
