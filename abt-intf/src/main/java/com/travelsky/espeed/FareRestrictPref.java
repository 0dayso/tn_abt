 ...
 *       &lt;attribute name="FareDisplayCurrency" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="FareCurrency" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "FareRestrictPref")
public class FareRestrictPref {

    @XmlAttribute(name = "FareDisplayCurrency", required = true)
    protected String fareDisplayCurrency;
    @XmlAttribute(name = "FareCurrency", required = true)
