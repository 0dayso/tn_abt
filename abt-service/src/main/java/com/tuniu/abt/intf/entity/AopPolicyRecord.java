...
@Table(name = "aop_policy_record")
public class AopPolicyRecord implements Serializable {
    private static final long serialVersionUID = 7451572646281352808L;
    ...
    public AopPolicyRecord(Long id, Integer vendorId, String ticketingOfficeNo, String ticketingAccountNo,
            String ticketingAccountPwd, String supplierOfficeNo, Integer delFlag, Date addTime, Date updateTime,
            Integer changePnrFlag, Integer policyEffectiveFlag, String actualTicketingOfficeNo, Integer subVendorId) {
        this.id = id;
